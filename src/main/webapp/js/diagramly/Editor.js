	...
	if (window.StyleFormatPanel != null)
	{
		...
		mxCellRenderer.defaultShapes['label'].prototype.customProperties = [
			{name: 'fieldType', dispName: 'Field Type', type: 'enum',
				enumList: [
                            {val: 'isSign', dispName: 'IS Sign'},
                            {val: 'upc', dispName: 'UPC'},
                            {val: 'offerDate', dispName: 'Offer Date'},
                            {val: 'limit', dispName: 'Limit'},
                            {val: 'expireDate', dispName: 'Expire Date'},
                            {val: 'itemName', dispName: 'Item Name'},
                            {val: 'itemDescription', dispName: 'Item Description'},
                            {val: 'unitPriceSign', dispName: 'Unit Price Sign'},
                            {val: 'priceAtTheRegisterSign', dispName: 'Price At The Register Sign'},
                            {val: 'wasSign', dispName: 'Was Sign'},
                            {val: 'discountSign', dispName: 'Discount Sign'},
                            {val: 'moneySign', dispName: 'Money Sign'},
                            {val: 'originalPrice', dispName: 'Original Price'},
                            {val: 'originalPriceDescription', dispName: 'Original Price Description'},
                            {val: 'discountValue', dispName: 'Discount Value'},
                            {val: 'currentPrice', dispName: 'Current Price'},
                            {val: 'currentPriceDescription', dispName: 'Current Price Description'},
